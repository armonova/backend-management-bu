...
export const create = ({ bodymen: { body: { email, link } } }, res, next) =>
  User.findOne({ email })
    ...
    .then((reset) => {
      ...
      const content = `
        Hey, ${user.name}.<br><br>
        You requested a new password for your Backend Management Bu account.<br>
        ...
        &mdash; Backend Management Bu Team
      `
      return sendMail({ toEmail: email, subject: 'Backend Management Bu - Password Reset', content })
    })
